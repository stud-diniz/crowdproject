...
class inner_walls():
    wallie1=[# 30° — short funnel, bottom at y=5.82
        Wall(0.5, 40.5,   14.75, 40.5,   0.5, 15.82,    0.5, 40.5),   # left
        Wall(30.5, 40.5,  16.25, 40.5,   30.5, 15.82,   30.5, 40.5)]  # right
    wallie2=[
    # 40° — medium funnel, bottom at y=18.54
        Wall(0.5, 40.5,   14.75, 40.5,   0.5, 28.54,   0.5, 40.5),   # left
        Wall(30.5, 40.5,  16.25, 40.5,   30.5, 28.54,  30.5, 40.5)]  # right
    wallie3=[
    # 60° — long funnel, bottom at y=22.7
        Wall(0.5, 40.5,   14.75, 40.5,   0.5, 32.7,   0.5, 40.5),   # left
        Wall(30.5, 40.5,  16.25, 40.5,   30.5, 32.7,  30.5, 40.5)]  # right